(function() {
  var API_URI, Quarter, Term, clients, file, goodJSON, http, quarters, redis, rest, server, static, sys, url, _;
    ...
    switch (deets.pathname) {
      case "/terms":
        if (deets.query.q) {
          ...
          return sys.puts("query string not defined");
        }
        break;
      case "/more":
        ...
        if (client) {
          ...
          return sys.puts("client id not defined");
        }
        break;
      default:
